          ...
          {currentTestimonials.map((testimonial: TestimonialType) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-3 md:mb-4">
                <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-xs md:text-sm">
              ...
              <div className="mt-auto text-right">
                <h3 className="text-[#444665] text-xs md:text-sm text-right font-bold">{testimonial.name}</h3>
              </div>
            </div>
          ))}
        </div>
